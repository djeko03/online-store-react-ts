        ...
        <div>
            <div className={scss.banners}>
                <div className={scss.orange}>
                    ...
                    <MyImage layout={MyLayout.responsive} width={584} height={200} src={'/img/special-offers-img/orangeSection.jpg'}/>
                </div>
                <div className={scss.green}>
                    ...
                    <MyImage layout={MyLayout.responsive} width={584} height={200} src={'/img/special-offers-img/greenSection.jpg'}/>
                </div>
            </div>
        </div>
  );
